...
const AppointmentHaircut = ({ navigation, text, lable }) => { 
  return (
    <View style={{ flex: 1, backgroundColor: 'black' }}>
      <CustomAppointment />

      <Text style={{
        color: 'white', textAlign: 'center', fontSize: 12, fontWeight: '600'
      }}>
      ...
      <TouchableOpacity>
        <Text style={{ color: '#FEC205', marginLeft: '70%', bottom: 18 }}>read more</Text>
      </TouchableOpacity>
...
export default AppointmentHaircut